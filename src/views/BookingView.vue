<template>
  ...
  <main class="w-full overflow-hidden">
    <div
      class="relative h-full mt-12 bg-primary/40 py-8 px-8 md:py-[4vw] md:px-[8.6vw]"
    >
      <div class="flex flex-col justify-center items-center bg-secondary">
        <h2
          class="font-title text-titleBase md:text-titleMed mt-[4vw] mb-[2vw]"
        >
          Réservation
        </h2>
        ...
        <form v-if="roomSelectionData" class="mb-[2vw] tracking-wider">
          ...
          <div class="mx-2 md:mx-4 lg:mx-8">
            ...
            <!--  optional services      -->
            <div class="mb-16">
              <h3 class="font-title text-titleBase mb-4">
              ...
              <ul>
                <li v-for="option in availableOptions" v-bind:key="option.id">
                  <label class="flex flex-row mb-2">
                    ...
                    <span
                      class="flex-1 border-b border-b-primary h-0 mt-auto mb-1 mx-1"
                    ></span>
            ...
            <div class="mb-16">
              ...
              <p>{{ totalPrice + selectedOptionsPrice }} €</p>
            </div>
          </div>
