<template>
  <div
    v-show="modalActive"
    class="absolute backdrop-blur-md fixed top-0 left-0 z-90 w-screen p-[2.6vw]
    flex flex-col justify-center items-center py-8 md:py-16 "
  >
    <div class="max-w-[1024px]">
      <div class="bg-primary text-secondary text-titleBase w-full flex p-[2.6vw] flex-row justify-between items-start">
