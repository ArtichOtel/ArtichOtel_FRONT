<template>
  ...
  >
    ...
    <div class="flex flex-col justify-center items-center bg-secondary">
      ...
      <h2 class="font-title text-titleBase md:text-titleMed mt-[4vw] mb-[2vw]">Connexion</h2>

      <form class="mb-[2vw] tracking-wider">
        <div class="flex gap-[2vw] mb-[3vw]">
          <div class="flex flex-col items-center">
            <label for="pseudo" class="block mb-4">Identifiant</label>
          ...
          <div class="flex flex-col items-center">
            <label for="password" class="block mb-4">Mot de passe</label>
        ...
        <div class="flex flex-col items-center gap-[1.2vw]">
          <button type="button" v-on:click="lostPW"
                  class="text-sm underline cursor-pointer tracking-wider">Mot de passe oublié ?</button>
